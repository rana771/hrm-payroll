            ...
            <div class="panel-content image-box">
                ...
                <div class="image-content font-white">
                    ...
                    <div class="meta-box meta-box-bottom">
                        ...
                        <h3 class="meta-heading">${employee.fullName}</h3>
                        <h4 class="meta-subheading">Sr. Manager</h4>
                    </div>

                </div>
                <img src="../../static/images/place_holder.jpg" alt="">
...
<div class="col-md-8">
    ...
    <!-- <div class="content-box bg-white post-box">
        <textarea name="" class="textarea-autosize" placeholder="Write a note "></textarea>
